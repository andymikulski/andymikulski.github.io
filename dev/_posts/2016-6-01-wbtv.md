...
<span>Each player uses different qualities but pulls from the same torrent.</span>
...
<span>An early plan was to create separate channels with show queues.</span>
